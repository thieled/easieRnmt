...
From version 0.0.3 onwards, the package's python backend that runs the `EasyNMT` library is managed by `uv` via `reticulate`.  This function initializes this backend, automatically installs the correct pytorch
